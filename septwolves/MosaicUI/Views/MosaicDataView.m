...
-(void)setModule:(MosaicData *)newModule{
    module = newModule;
    //NSLog(@"%@",self.module.imageFilename);
    /*[imageView setImageWithURL:[NSURL URLWithString:self.module.imageFilename] placeholderImage:[UIImage imageNamed:@"man1.png"] completed:^(UIImage *anImage, NSError *error, SDImageCacheType cacheType) {
        NSLog(@"cacheType:%u",cacheType);
